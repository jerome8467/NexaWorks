...
{
    public class GetTicketWithInclude_Test
    {
        private readonly ApplicationDbContext _database;
        private readonly RequestRepository _requestRepository;

        public GetTicketWithInclude_Test()
        {
        ...
        public void Request1()
        {
            ...
            // Act
            IEnumerable<Ticket> tickets = _requestRepository.GetTicketsWithInclude(
                productId: null,
            ...
            Assert.All(tickets, t => Assert.Equal(1, t.StatusTicketId));
            Assert.All(tickets, t => Assert.Equal("En cours", t.StatusTicket.Title));
        }
        ...
        public void Request2()
        {
            ...
            Assert.All(tickets, t => Assert.Equal(1, t.StatusTicketId));
            Assert.All(tickets, t => Assert.Equal("En cours", t.StatusTicket.Title));
            Assert.All(tickets, t => Assert.Equal(1, t.VersionOs.VersionProduct.ProductId));
        }
        ...
        public void Request3()
        {
            ...
            Assert.All(tickets, t => Assert.Equal("En cours", t.StatusTicket.Title));
            Assert.All(tickets, t => Assert.Equal(1, t.VersionOs.VersionProduct.ProductId));
            Assert.All(tickets, t => Assert.Equal(4, t.VersionOs.VersionProductId));
        }
        ...
        public void Request10()
        {
            ...
            Assert.NotNull(tickets);
            Assert.Equal(countNoResolve, tickets.Count());
            Assert.All(tickets, t => Assert.Equal(2, t.VersionOs.VersionProduct.ProductId));
            Assert.All(tickets, t => Assert.Equal(5, t.VersionOs.VersionProductId));
        ...
        public void Request11()
        {
            ...
            Assert.NotNull(tickets);
            Assert.Equal(countNoResolve, tickets.Count());
            Assert.All(tickets, t => Assert.Equal(2, t.StatusTicketId));
            Assert.All(tickets, t => Assert.Equal("Résolu", t.StatusTicket.Title));
        }
